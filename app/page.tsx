...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center bg-gradient-to-br from-blue-100 via-purple-100 to-fuchsia-100 px-10 py-16 border-r border-gray-300">
      ...
      <div className="w-full md:w-1/2 relative flex items-center justify-center bg-gradient-to-tr from-indigo-600 via-violet-600 to-pink-500 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <img
            ...
            className="w-72 md:w-96 mx-auto mb-6 rounded-xl shadow-xl border-4 border-white/60"
          />
